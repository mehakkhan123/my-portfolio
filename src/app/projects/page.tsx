          ...
          <div className='flex flex-col items-center pt-8 justify-center sm:flex-row gap-5 flex-wrap'>
                      {
                          projects.map((item)=>{
                              ...
                              return(
                                  <div key={item.id} className='flex flex-col items-center justify-start bg-gray-50 rounded-lg shadow-md max-w-[300px] min-h-[720px] transition-all duration-700 ease-in-out gap-3 p-5'>
                                    <Image src={item.image} alt={item.name} width={600} height={600} className='h-[200px] object-cover'/>
