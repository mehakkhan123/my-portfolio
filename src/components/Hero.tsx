...
export default function Hero() {
  return (
    <div className='flex flex-col w-full items-center p-6 max-w-[1536px] gap-4 bg-gray-50 md:flex-row md:gap-0 md:justify-between'>
        ...
        <Link href={"/projects"}>
        <button className='bg-yellow-500 p-2 rounded-sm text-white font-medium border-2 border-transparent hover:border-2 hover:border-yellow-500 hover:bg-white hover:text-yellow-500 cursor-pointer transition-all duration-300 ease-in-out md:text-2xl'>View My Work</button>
        </Link>
        </div>
